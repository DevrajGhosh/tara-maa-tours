      ...
      <section className="py-20 bg-surface-mid">
        <div className="max-w-container mx-auto px-5 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-2xl overflow-hidden border border-outline-light shadow-lg h-72 md:h-96">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1839.9062016080825!2d88.48185026554903!3d22.735213081383638!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f8a3d72092c855%3A0xccfe49d31aff821f!2sMaa%20Tara%20Building!5e0!3m2!1sen!2sin!4v1782664699087!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
          </div>
        </div>
      </section>
    </div>
