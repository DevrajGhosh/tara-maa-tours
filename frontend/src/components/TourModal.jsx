...
const WHATSAPP = '918637090545'   // ← CHANGE to your WhatsApp number (with country code, no +)
const PHONE    = '+91 86370 90545' // ← CHANGE to your phone
const EMAIL    = 'devrajghosh2525@gmail.com' // ← CHANGE to your email
...
export default function TourModal({ tour, onClose }) {
  ...
  const emailSubject = encodeURIComponent(`Tour Inquiry: ${tour.name}`)
  const emailBody = encodeURIComponent(`Hello Tara Maa Tours,\n\nI am interested in the "${tour.name}" (${tour.duration}) package.\n\nPlease send me more details about availability and pricing.\n\nThank you!`)
      ...
      <div className="bg-white w-full md:max-w-3xl md:rounded-2xl rounded-t-2xl max-h-[92vh] flex flex-col overflow-hidden shadow-2xl">
        ...
        <div className="relative h-52 shrink-0">
          ...
          <div className="absolute bottom-4 left-5 right-5">
            ...
            <div className="flex gap-4 mt-1 text-white/80 text-xs">
        ...
        <div className="overflow-y-auto flex-1 p-5 space-y-6">
          ...
          {/* Short description */}
          <p className="text-on-surface-var text-sm leading-relaxed">{tour.shortDescription}</p>
        ...
        <div className="shrink-0 p-4 border-t border-outline-light bg-surface-low">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <a
              ...
              className="flex flex-col items-center gap-1 bg-primary text-white rounded-xl py-3 hover:bg-primary-light transition-all active:scale-95 text-center"
            >
