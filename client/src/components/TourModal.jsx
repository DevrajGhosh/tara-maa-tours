...
const WHATSAPP = '8637090545'   // ← CHANGE to your WhatsApp number (with country code, no +)
const PHONE    = '+91 8637090545' // ← CHANGE to your phone
const EMAIL    = 'devrajghosh2526@gmail.com' // ← CHANGE to your email
