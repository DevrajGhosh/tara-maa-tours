const TEAM = [
  { name: 'Sujata Devi',    role: 'Founder & Tour Director',  icon: 'person', bio: '20+ years of curating heartfelt India experiences. Born explorer, West Bengal native.' },
  { name: 'Arjun Roy',      role: 'Head of Operations',       icon: 'person', bio: 'Logistics genius who ensures every pickup, hotel, and permit is perfectly in place.' },
  { name: 'Priyanka Ghosh', role: 'Travel Experience Designer', icon: 'person', bio: 'Creates the magical itineraries that make our guests say "this was better than expected."' },
]
...
const VALUES = [
  ...
  { icon: 'stars',           title: 'Attention to Detail', desc: 'From the right hotel pillow to the perfect sunrise timing — every detail is crafted with care.' },
]
...
export default function About() {
  return (
    <div className="bg-surface min-h-screen">
      ...
      {/* Hero */}
      <section className="relative py-24 overflow-hidden bg-surface-low border-b border-outline-light">
        <div className="max-w-container mx-auto px-5 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-on-surface-var text-lg leading-relaxed mb-6">
              Tara Maa Tours & Travels was founded with a simple mission — to help people truly experience the beauty, diversity, and soul of India. Based in West Bengal, we are a family-run agency that has been designing heartfelt journeys for over a decade.
            </p>
            ...
            <div className="flex flex-wrap gap-8">
              {[['10+', 'Years in Travel'], ['500+', 'Happy Travellers'], ['25+', 'Destinations Covered'], ['50+', 'Tour Packages']].map(([num, label]) => (
                <div key={label}>
          ...
          <div className="relative">
            <div className="aspect-square rounded-2xl overflow-hidden border-4 border-white shadow-2xl">
              <img
                src="https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=600&auto=format&fit=crop"
                alt="Team at work"
